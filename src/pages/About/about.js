        ...
        <>
            ...
            >
                ...
                {shownSections.includes(3) && (
                    <div className="Sec1" ref={lastSectionRef}>
                        <h1>
                            what else?
                        </h1>
                    </div>
                ...
                {shownSections.includes(3) && (
                    <div className='Sec2'>
                        <p> I'm not just an average coder. I'm also diving into the world of Penetration Testing and
                            ...
                            Whether it's a quick hack or a full-blown project, count me in —— <i>I'm always up for the challenge!
                                💻✨</i>. I bring a mix of tech wizardry and passion to the table. So, if you
